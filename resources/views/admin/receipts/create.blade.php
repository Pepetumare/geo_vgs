            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="flex justify-between items-center">
                        ...
                        <a href="{{ route('admin.receipts.history') }}" class="text-sm text-indigo-600 hover:underline">
                            Ver Historial por RUT
                        </a>
                    </div>
                    <form action="{{ route('admin.receipts.store') }}" method="POST" class="mt-6 space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="client_rut" id="client_rut"
                                class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 shadow-sm">
                        </div>
                        <div>
                            <label for="description" class="block text-sm font-medium">Descripción del
                                Servicio/Producto</label>
                            <textarea name="description" id="description" rows="3"
                                class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 shadow-sm" required></textarea>
                        </div>
                        <div>
                            <label for="total_amount" class="block text-sm font-medium">Monto Total ($)</label>
